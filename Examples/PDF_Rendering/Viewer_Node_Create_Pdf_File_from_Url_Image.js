"use strict";
class Viewer_Node_Create_Pdf_File_from_Url_Image {
	static Run() {
		...
		var request = new groupdocs_viewer_cloud_1.ImageCreatePdfFileFromUrlRequest(fileUrl, pdfFileOptions);
		request.folder = folderName;
		viewerApi.imageCreatePdfFileFromUrl(request)
...
module.exports = Viewer_Node_Create_Pdf_File_from_Url_Image;